...
const ProductDetail: React.FC = () => {
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen text-white selection:bg-[#d4af37] selection:text-[#0a0a0a]">
            ...
            <div className="space-y-4 pt-4 border-l border-[#d4af37]/20 pl-6">
               <div className="flex items-center gap-4 text-gray-300">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 uppercase tracking-tighter">Durabilitas unit ekstrim.</p>
                  </div>
               </div>
               <div className="flex items-center gap-4 text-gray-300">
                  <Zap className="text-[#d4af37]" size={24} />
                  <div>
                    <p className="text-xs font-bold tracking-widest uppercase">Energy Optimization</p>
                    <p className="text-[10px] text-gray-500 uppercase tracking-tighter">VRT Technology integration.</p>
                  </div>
               </div>
            </div>
            <div className="pt-6">
      ...
      {/* FITUR UNGGULAN - Spacing reduced */}
        ...
        <div className="max-w-[85%] mx-auto px-8">
           <div className="flex flex-col md:flex-row gap-16 items-start">
             <div className="md:w-1/3 space-y-4 text-left">
                ...
                <h2 className="text-4xl font-luxury font-bold uppercase">FITUR UNGGULAN</h2>
             </div>
             <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10 text-left">
                {product.features.map((feature, i) => (
                  <div key={i} className="flex gap-6 items-start group">
                    ...
                    <div>
                      <h4 className="font-bold text-sm tracking-widest uppercase mb-2">{feature}</h4>
                      <p className="text-xs text-gray-500 font-light leading-relaxed">Menjamin performa optimal dan integrasi kontrol cerdas yang memudahkan operasional.</p>
                    </div>
                  </div>
                ))}
             </div>
      ...
      {/* APLIKASI COCOK - Spacing reduced */}
      <section className="py-16 bg-black">
        <div className="max-w-[85%] mx-auto px-8 text-left">
          <div className="mb-12 space-y-4">
             <p className="text-[#d4af37] text-xs font-bold tracking-[0.5em] uppercase">Usage Scenarios</p>
             <h2 className="text-4xl font-luxury font-bold uppercase tracking-widest">APLIKASI IDEAL</h2>
        ...
        <div className="max-w-[85%] mx-auto px-8 text-left">
          <div className="flex justify-between items-end mb-12">
            <div className="space-y-2">
              ...
              <h2 className="text-4xl font-luxury font-bold uppercase">PROYEK TERKAIT</h2>
            </div>
            <Link to="/portfolio" className="gold-gradient px-8 py-3 rounded-full text-[#0a0a0a] text-[10px] font-bold uppercase tracking-widest">
